...
contract Aurbit777 is ERC777 {
    ...
    constructor(address payable planet0)
        public
    ...
    //figure out user and operator data fields and what to do with them
    ...
    function mintInternal(uint256 amount) public {
        require(ismintAuthed(), "UNAUTHORIZED");
    ...
    function authMinter(address payable _minter) public {
        require(ismintAuthed(), "UNAUTHORZIED");
